...
const UbicacionFechaTerceros: React.FC<UbicacionFechaTercerosProps> = ({ formData, handleChange, handleFieldChange }) => {

    const [ubicacion, setUbicacion] = useState<string>(formData.ubicacionTercero);
    ...
    return (
        <>
                ...
                <Col md={6}>
                    <Form.Group controlId="departamento">
                        ...
                        <Form.Select
                            required
                            name="departamento"
                            value={formData.departamentoTercero}
            ...
            {ubicacion === "rural" && (
                <CamposRurales formData={formData.ruralFieldsTercero} handleFieldChange={handleFieldChange} formDataField={'rural'}/>
            )}

            {ubicacion === "urbana" && (
                <CamposUrbanos formData={formData.urbanaFieldsTercero} handleFieldChange={handleFieldChange} formDataField={'urbana'}></CamposUrbanos>
            )}
        </>
    );
};

export default UbicacionFechaTerceros;
